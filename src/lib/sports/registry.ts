...
export const SPORTS: Record<SportId, SportConfig> = {
  bike: {
    ...
    metrics: [
      ...
      { key: "power_balance_right", label: "Balance der.", unit: "%" },
      { key: "left_pp_arc", label: "Arco de fuerza izq.", unit: "°" },
      { key: "right_pp_arc", label: "Arco de fuerza der.", unit: "°" },
      { key: "left_pp_center", label: "Centro de fuerza izq.", unit: "°" },
      { key: "right_pp_center", label: "Centro de fuerza der.", unit: "°" },
